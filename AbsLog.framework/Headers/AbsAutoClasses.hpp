...
public:
    ...
    // next methods is used only by AbsLog lib
    ABS_ATTR_VISIBILITY(hidden) int dupFileDescriptor(int anotherDescriptor) const;
    ABS_ATTR_VISIBILITY(hidden) void enableLogging2Stdout();
};
